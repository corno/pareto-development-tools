...
import type * as s_error from "../../parse/schema.js"
import type * as s_publish from "../../publish/schema.js"
import type * as s_out_publish from "../../publish/schema.js"
...
>
    ...
    >({
        ...
        end_info: null,
        assign: (iterator) => ({
            'type': iterator.consume_with_expectation<s_out.Parameters['type'], s_error.Error>(
                ...
                ($) => {
                    switch ($) {
                        case "all": return ['all packages', {
                            ...
                            'instruction': iterator.consume_with_expectation<s_out.All_Pacakges_Instruction, s_error.Error>(
                                ['expected one of', p_.literal.dictionary({
                        ...
                        case "package": return ['package', {
                            ...
                            'instruction': iterator.consume_with_expectation<s_out.Package.instruction, s_error.Error>(
                                ['expected one of', p_.literal.dictionary({
                                    "assert-no-open-changes": null,
                                    "build-and-validate": null,
                                    "commit-changes": null,
                                ...
                                ($, expected) => {
                                    switch ($) {
                                        ...
                                        case "publish": return ['publish', {
                                            'generation': iterator.consume_with_expectation<s_out_publish.Parameters2.generation, s_error.Error>(
                                                ['expected one of', p_.literal.dictionary({
                                                    "patch": null,
                                                    "minor": null,
                                                })],
                        ...
                        case "project": return ['project', {
                            ...
                            'instruction': iterator.consume_with_expectation<s_out.Project.instruction, s_error.Error>(
                                ['expected one of', p_.literal.dictionary({
