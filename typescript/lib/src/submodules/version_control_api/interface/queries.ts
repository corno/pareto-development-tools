...
export type repository_no_open_changes = p_.Query_Interface<
    d_repository_no_open_changes.Result,
    d_repository_no_open_changes.Error,
    d_repository_no_open_changes.Parameters
>
export type is_inside_work_tree = p_.Query_Interface<
    d_is_inside_work_tree.Result,
    d_is_inside_work_tree.Error,
    d_is_inside_work_tree.Parameters
>
