...
export type extended_commit = p_.Command_Action<d_extended_commit.Error, d_extended_commit.Parameters>
export type push = p_.Command_Action<d_push.Error, d_push.Parameters>
