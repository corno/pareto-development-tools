...
exports.determine_project_state = determine_project_state;
const fs = require('fs');
 ...
 */
function determine_git_state(project_path) {
    try {
 ...
 */
function determine_package_and_dependencies(project_path, node_name) {
    ...
    try {
        ...
        for (const [dep_name, dep_version] of Object.entries(prod_dependencies)) {
            const version_string = dep_version;
...
function determine_project_state(project_path, node_name) {
