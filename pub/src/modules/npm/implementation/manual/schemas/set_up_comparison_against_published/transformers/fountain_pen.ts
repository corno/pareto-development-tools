    ...
    return _p.decide.state($, ($): d_out.Block_Part => {
        switch ($[0]) {
            case 'error while running npm command': return _p.ss($, ($) => sh.b.sub([
                sh.b.literal("error while running npm command: "),
                sh.b.indent([
                    sh.g.nested_block([
            ...
            case 'error while running npm query': return _p.ss($, ($) => sh.b.sub([
                sh.b.literal("error while running npm query: "),
                sh.b.indent([
                    sh.g.nested_block([
            ...
            case 'error while running tar': return _p.ss($, ($) => sh.b.sub([
                sh.b.literal("error while running tar: "),
                sh.b.indent([
                    sh.g.nested_block([
                        t_epe_to_fountain_pen.Error($)
                    ])
            ...
            case 'error while creating directory': return _p.ss($, ($) => sh.b.sub([
                sh.b.literal("error while creating directory: "),
                sh.b.indent([
                    sh.g.nested_block([
            ...
            case 'error while removing directory': return _p.ss($, ($) => sh.b.sub([
                sh.b.literal("error while removing directory: "),
                sh.b.indent([
                    sh.g.nested_block([
