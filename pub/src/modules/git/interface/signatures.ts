...
export namespace commands {
    ...
    export type assert_is_clean = _et.Command_Procedure<
    ...
    export type clean = _et.Command_Procedure<
    ...
    export type extended_commit = _et.Command_Procedure<
    ...
    export type remove_tracked_but_ignored = _et.Command_Procedure<
