 ...
 */
function match_pattern_part(pattern_part: string, path_part: string): boolean {
    if (pattern_part === '*') {
 ...
 */
function matches_wildcard(relative_path: string, pattern: string): boolean {
 ...
 */
function get_file_tree(dir_path: string, relative_path: string = '', structure: any = null, repo_path: string = '', wildcard_base_path: string = ''): any[] {
    const issues: any[] = [];
...
export const $$ = (repo_path: string, structure: any): Status => {
