...
const { validate_repository_structure } = require('../../lib/structure_validation_utils');
...
// Use dependency analysis to get packages in topological order
...
// Display results (in topological order, no sorting)
